...
public class SwiftQiscusMeetPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  var window: UIWindow?
       ...
       var jitsiViewController: QiscusViewController?
       ...
       public static func register(with registrar: FlutterPluginRegistrar) {
           let channel = FlutterMethodChannel(name: "qiscus_meet", binaryMessenger: registrar.messenger())

           let viewController: UIViewController =
               (UIApplication.shared.delegate?.window??.rootViewController)!

           let instance = SwiftQiscusMeetPlugin(uiViewController: viewController)

           registrar.addMethodCallDelegate(instance, channel: channel)

           // Set up event channel for conference events
           let eventChannelName = "qiscus_meet_events"
       ...
       public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
           ...
           if (call.method == "joinMeeting") {
               ...
               self.jitsiViewController = QiscusViewController.init()
